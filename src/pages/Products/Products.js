...
export default function Products() {
  ...
  return (
    <div className="products__wrapper">
      <div className="products__top-menu">
        {!removeProducts
          ? <Button
            ...
            isIcon={addProducts ? <Icon faIcon={faEye} /> : <Icon faIcon={faPlus} />}
        ...
        {!addProducts
          ? <Button
            ...
            isText={`${removeProducts ? 'Ocultar panel' : 'Seleccionar productos'}`}
            isIcon={removeProducts ? <Icon faIcon={faEye} /> : <Icon faIcon={faPizzaSlice} />}
      ...
      {addProducts
        ? <ProductsAdd />
        : <ProductsList removeProducts={removeProducts} isRemove={removeReady} />}
    </div>
  )
}
